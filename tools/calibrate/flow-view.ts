...
function renderStep(step: FlowStep, index: number): string {
  ...
  return `<article class="step">
    ...
    <div class="columns">
      <figure><a class="full-size" href="${escapeHtml(step.screenshot)}" target="_blank" rel="noopener"><img src="${escapeHtml(step.screenshot)}" alt="Screenshot for ${escapeHtml(entry.label)}"></a><figcaption>${escapeHtml(entry.label)} · <a href="${escapeHtml(step.screenshot)}" target="_blank" rel="noopener">Open full-size screenshot</a></figcaption></figure>
...
function renderReport(fund: HealthFundId, steps: readonly FlowStep[]): string {
  ...
  :root{color-scheme:light;background:#f3efe6;color:#17221c;font:16px/1.5 ui-sans-serif,system-ui,sans-serif}*{box-sizing:border-box}body{margin:0}.shell{width:100%;max-width:none;margin:0;padding:40px 24px 80px}h1{font:700 clamp(2rem,5vw,4.5rem)/.95 Georgia,serif;margin:.2em 0}h2{margin:64px 0 16px;border-bottom:2px solid #17221c;padding-bottom:8px}.eyebrow{text-transform:uppercase;letter-spacing:.15em;color:#775d37}.step{background:#fff;border:1px solid #c7bfae;margin:18px 0;box-shadow:5px 5px 0 #17221c}.step>header{display:flex;gap:14px;align-items:center;padding:16px;border-bottom:1px solid #c7bfae}.step h3,.step h4{margin:0}.step a{color:#516159;overflow-wrap:anywhere}.number{display:grid;place-items:center;width:38px;height:38px;border-radius:50%;background:#17221c;color:#fff;font-weight:700}.columns{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(420px,1fr);align-items:start;gap:24px;padding:20px}figure{margin:0}.full-size{display:block}img{display:block;width:100%;height:auto;max-height:none;background:#eee;border:1px solid #c7bfae}figcaption{font-family:monospace;margin-top:6px}pre{white-space:pre-wrap;overflow-wrap:anywhere;background:#f5f3ed;padding:10px;border-left:3px solid #775d37}.binding{border-top:1px solid #ddd;padding:10px 0}.binding.empty{background:#fff1ef;border-left:5px solid #b33225;padding-left:10px}.binding.empty dd strong:after{content:' · EMPTY';color:#b33225}.pending{padding:18px;background:#fff5c7;border-left:5px solid #b7860b;font-weight:700}dl,dd{margin-left:0}@media(max-width:1100px){.columns{grid-template-columns:1fr}.shell{padding:24px 12px}.step{box-shadow:3px 3px 0 #17221c}}
